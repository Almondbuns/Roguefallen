...
public class ItemAxe1H : ItemPrototype
{
    public ItemAxe1H(int level) : base(level)
    {
        name = "Axe";
        type = ItemType.WEAPON;
        icon = "images/objects/weapon_axe_1H";
        weight = 10;
        gold_value = 100 * (level+1);
        List<(DamageType, int, int, int)> weapon_damage = new();
        weapon_damage.Add((DamageType.SLASH, 4 + level, 7 + level, 1 + level));
        ...
        required_attributes.strength = 5 * (level+1);
...
public class ItemAxe2H : ItemPrototype
{
    public ItemAxe2H(int level) : base(level)
    {
        name = "Axe";
        type = ItemType.WEAPON;
        ...
        weapon = new WeaponPrototype
        {
            sub_type = WeaponSubType.AXE,
            equip_type = WeaponEquipType.TWOHANDED,
            damage = { (DamageType.SLASH, 3 + level, 6 + level, 0) },
            attack_talents =
            {
                new TalentWeaponAttackFast(),
                //new TalentAttackStandard(),
