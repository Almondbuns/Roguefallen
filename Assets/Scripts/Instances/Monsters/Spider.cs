...
public class CommonSpider : ActorPrototype
{
    public CommonSpider(int level) : base(level)
    {
...
public class CaveSpider : ActorPrototype
{
...
public class PoisonSpider : ActorPrototype
{
    public PoisonSpider(int level) : base(level)
    {
        name = "Poison Spider";
